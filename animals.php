...
<head>
	...
	<title>Ben Reid - Animal Photography</title>
</head>
...
<body>
	...
	<div class="gallery">
		<div class="menu">
			<h1>Animal Photos</h1>
			<p>Different shots of different animals, domesitcated and wild</p>
		</div>
		
		<div align="center">
			<?php
				include("assets/gallery.php");
				print(printGalleryGrid(listDirectory("assets/images/photography/animals/")));
			?>
		</div>
	</div>
