...
<head>
	...
	<title>Ben Reid - Abandoned Photography</title>
</head>
...
<body>
	...
	<div class="gallery">
		<div class="menu">
			<h1>Abandoned Building Photos</h1>
			<p>Photos from abandoned places</p>
		</div>
		
		<div align="center">
			<?php
				include("assets/gallery.php");
				print(printGalleryGrid(listDirectory("assets/images/photography/abandoned/")));
			?>
		</div>
	</div>
